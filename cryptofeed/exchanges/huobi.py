...
from cryptofeed.defines import BUY, CANDLES, HUOBI, L2_BOOK, SELL, TICKER, TRADES
...
class Huobi(Feed):
    ...
    websocket_channels = {L2_BOOK: "depth.step0", TRADES: "trade.detail", CANDLES: "kline", TICKER: "ticker"}
    ...
    async def _book(self, msg: dict, timestamp: float):
        ...
        await self.book_callback(
            L2_BOOK, self._l2_book[pair], timestamp, timestamp=self.timestamp_normalize(msg["ts"]), raw=msg
        )
