...
from cryptofeed.defines import ASK, BID, BUY, COINBASE, L2_BOOK, SELL, TRADES
...
def get_private_parameters(
    config: Config, chan: str = None, product_ids_str: list = None, rest_api: bool = False, endpoint: str = None
) -> dict:
