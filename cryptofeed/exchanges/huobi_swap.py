...
from cryptofeed.defines import FUNDING, HUOBI_SWAP, PERPETUAL
...
class HuobiSwap(HuobiDM):
    ...
    rest_endpoints = [
        RestEndpoint(
            "https://api.hbdm.com",
            routes=Routes("/swap-api/v1/swap_contract_info", funding="/swap-api/v1/swap_funding_rate?contract_code={}"),
