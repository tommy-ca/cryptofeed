...
from cryptofeed.defines import ASK, BID, BUY, CANDLES, GATEIO, L2_BOOK, SELL, TICKER, TRADES
...
class Gateio(Feed):
    ...
    rest_endpoints = [
        RestEndpoint(
            "https://api.gateio.ws",
            routes=Routes(
                "/api/v4/spot/currency_pairs", l2book="/api/v4/spot/order_book?currency_pair={}&limit=100&with_id=true"
            ),
        )
    ]
