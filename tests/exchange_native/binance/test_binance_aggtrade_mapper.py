...
def test_binance_aggtrade_to_common_trade():
    ...
    data = json.load(open(os.path.join(ROOT,'tests/fixtures/exchange-native/binance/aggTrade_um.json')))
    native = b.Trade(symbol=data['s']); native.segment = b.MARKET_SEGMENT_FUTURES_UM
