...
def test_okx_option_trade_sell_side_maps_correctly():
    ...
    data = json.load(open(os.path.join(ROOT,'tests/fixtures/exchange-native/okx/trade_option_sell.json')))
