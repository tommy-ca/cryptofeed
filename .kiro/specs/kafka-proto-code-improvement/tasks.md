...
- [ ] 1.2 Add regression checks for legacy backend path
...
- [ ] 2. Reorganize protobuf helpers into dedicated module tree
- [ ] 2.1 Create `backends/protobuf/` package structure
...
- [ ] 2.2 Move existing converter and serialization logic into new modules
...
- [ ] 2.3 Introduce schema validation surface for protobuf payloads
...
- [ ] 2.4 Add compatibility shims for legacy protobuf imports
...
- [ ] 3. Reorganize Kafka callbacks into colocated modules
- [ ] 3.1 Establish `backends/kafka/` package and move supporting modules
...
- [ ] 3.2 Extract TopicManager, Partitioner, HeaderEnricher, and metrics modules
...
- [ ] 3.3 Implement KafkaBackendBase for shared infrastructure
...
- [ ] 3.4 Refactor unified KafkaCallback to inherit from the base
...
- [ ] 3.5 Harden compatibility shims and import graph
...
- [ ] 4. Deliver protobuf-only Kafka backend
- [ ] 4.1 Implement KafkaProtobufCallback on top of KafkaBackendBase
...
- [ ] 4.2 Integrate SchemaValidator and serialization pipeline
...
- [ ] 4.3 Add targeted tests for protobuf-only backend
...
- [ ] 5. Instrument metrics and schema metadata for all backends
- [ ] 5.1 Wire metrics module into KafkaBackendBase and callbacks
...
- [ ] 5.2 Document and enforce schema version headers
...
- [ ] 5.3 Run compatibility and import matrix checks
...
- [ ] 6.1 Update existing unit/integration suites to new module locations
...
- [ ] 6.2 Add regression tests for compatibility shims
